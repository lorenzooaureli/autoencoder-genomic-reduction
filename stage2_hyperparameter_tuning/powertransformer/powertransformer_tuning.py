...
base_output_dir = "/clusterfs/jgi/scratch/science/mgs/nelli/lorenzo/ML_models/dataset_16_feb/scaled_dataset/tuning_models/powertransformer"
...
# We've already created this in the evaluation step
